...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__24(Vtop___024root* vlSelf) {
    ...
    if ((0x8fU == (IData)(vlSelfRef.top__DOT__soc__DOT__ppu_LY))) {
        vlSelfRef.__Vdly__top__DOT__soc__DOT__vblank_FF = 1U;
    }
    if (((0x90U == (IData)(vlSelfRef.top__DOT__soc__DOT__ppu_LY)) 
         & (IData)(vlSelfRef.top__DOT__soc__DOT__vblank_FF))) {
        vlSelfRef.__Vdly__top__DOT__soc__DOT__vblank_FF = 0U;
        vlSelfRef.top__DOT__soc__DOT__io_IF = 1U;
        vlSelfRef.top__DOT__soc__DOT__cpu_int_n = 0U;
    }
    vlSelfRef.top__DOT__soc__DOT__vblank_FF = vlSelfRef.__Vdly__top__DOT__soc__DOT__vblank_FF;
